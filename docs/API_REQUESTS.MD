...
Result of the model inference is the dictionary with model's outputs names as keys and values formatted according to model's output or output filter interface.
